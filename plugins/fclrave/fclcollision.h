...
#define START_TIMING_OPT(statistics, label, options, isRobot) \
    ...
    typedef std::pair<fcl::CollisionObject<float> *, fcl::CollisionObject<float> *> CollisionPair;
...
namespace std
{
    ...
    struct hash<fclrave::CollisionPair>
    {
        ...
        {
            static const size_t shift = (size_t)log2(1 + sizeof(fcl::CollisionObject<float> *));
...
namespace fclrave
{
    ...
    typedef std::unordered_map<CollisionPair, fcl::Vector3f> NarrowCollisionCache;
    ...
    public:
        ...
        public:
            ...
            fcl::CollisionRequest<float> _request;
            fcl::CollisionResult<float> _result;
            fcl::DistanceRequest<float> _distanceRequest;
            fcl::DistanceResult<float> _distanceResult;
    ...
    private:
        ...
        static bool CheckNarrowPhaseCollision(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, void *data);

        bool CheckNarrowPhaseCollision(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, CollisionCallbackData *pcb);

        static bool CheckNarrowPhaseGeomCollision(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, void *data);

        bool CheckNarrowPhaseGeomCollision(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, CollisionCallbackData *pcb);

        static bool CheckNarrowPhaseDistance(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, void *data, float &dist);

        bool CheckNarrowPhaseDistance(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, CollisionCallbackData *pcb, float &dist);

        static bool CheckNarrowPhaseGeomDistance(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, void *data, float &dist);

        bool CheckNarrowPhaseGeomDistance(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2, CollisionCallbackData *pcb, float &dist);

#ifdef NARROW_COLLISION_CACHING
        static CollisionPair MakeCollisionPair(fcl::CollisionObject<float> *o1, fcl::CollisionObject<float> *o2);
#endif
        ...
        std::pair<FCLSpace::FCLKinBodyInfo::LinkInfo *, LinkConstPtr> GetCollisionLink(const fcl::CollisionObject<float> &collObj);

        std::pair<FCLSpace::FCLKinBodyInfo::FCLGeometryInfo *, GeometryConstPtr> GetCollisionGeometry(const fcl::CollisionObject<float> &collObj);
...
#ifdef FCLRAVE_COLLISION_OBJECTS_STATISTICS
        std::map<fcl::CollisionObject<float> *, int> _currentlyused;
        std::map<fcl::CollisionObject<float> *, std::map<int, int>> _usestatistics;
#endif
        ...
        std::vector<fcl::Vector3f> _fclPointsCache;
