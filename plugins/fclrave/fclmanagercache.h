...
namespace fclrave
{
    ...
    typedef boost::shared_ptr<fcl::BroadPhaseCollisionManager<float>> BroadPhaseCollisionManagerPtr;
    typedef boost::weak_ptr<fcl::BroadPhaseCollisionManager<float>> BroadPhaseCollisionManagerWeakPtr;
